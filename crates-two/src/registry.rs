...
use crate::{ValidationError, builder::ResourceBuilderView, node::Node, node_spec, params::Params, spec::{NodeFactory, NodeSpec}};
...
pub fn get_spec_for_runtime(name: String, runtime_factory: NodeFactory) -> NodeSpec {
    node_spec!(name, required = [], optional = [], build = runtime_factory)
}
...
impl Default for AudioRegistry {
    fn default() -> Self {
        ...
        //             Ok(AddNode::TrackMixer {
        //                 chans_per_track: chans_per_track,
        //                 tracks: tracks,
        //                 gain: gain,
        //             })
        //         }
